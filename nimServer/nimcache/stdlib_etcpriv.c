...
/* Command for C compiler:
   clang -c  -w  -I/usr/local/Cellar/nim/0.15.0/nim/lib -o /Users/jceipek/Development/Work/Thesis/nimServer/nimcache/stdlib_etcpriv.o /Users/jceipek/Development/Work/Thesis/nimServer/nimcache/stdlib_etcpriv.c */
...
static N_INLINE(NIM_BOOL, ismagicidentseparatorrune_153005_3239285623)(NCSTRING cs0, NI i0) {
	...
	if (!(LOC2)) goto LA3;
	nimln(22, "etcpriv.nim");
	T3239285623_2 = addInt(i0, ((NI) 1));
	LOC2 = ((NU8)(cs0[(NI)(T3239285623_2)]) == (NU8)(128));
	LA3: ;
	LOC1 = LOC2;
	if (!(LOC1)) goto LA4;
	nimln(23, "etcpriv.nim");
	T3239285623_3 = addInt(i0, ((NI) 2));
	LOC1 = ((NU8)(cs0[(NI)(T3239285623_3)]) == (NU8)(147));
	LA4: ;
	result0 = LOC1;
	popFrame();
	return result0;
